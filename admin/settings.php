		...
		<div class="right"><br><br>
			...
			<center>
				...
				while ($row = mysql_fetch_array($query)) {
					...
					<input type="password" name="password" class="form" placeholder="Entrer le mot de pass " required="required"><br><br>
					<input type="password" name="password2" class="form" placeholder="Rentrée le mot de passe" required="required"><br><br>
					<?php
				}
				 ?>
				<input type="submit" value="Mise a Jour" class="btnlink" name="btn">
			</form>
			<?php
			extract($_POST);
